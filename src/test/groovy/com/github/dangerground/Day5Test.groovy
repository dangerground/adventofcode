...
class Day5Test extends Specification {
    ...
    @Unroll
    def "run jump opcodes (#input) = #output -> #program"(String program, int input, int output) {
        given:
    ...
    def "calculate program code - part 2"() {
        ...
        and:
        println(input)
        def day5 = new Day5(input, 5)

        when:
        day5.runProgram()

        then:
        println "out: ${day5.lastOutput}"
    }
}
